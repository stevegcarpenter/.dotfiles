...
#   export EDITOR='mvim'
# fi
# Preferred editor: nvim, falling back to vim where nvim isn't installed
...
nvm use default >/dev/null 2>&1  # This will automatically use v22 and suppress the output
# Load correct version of node
